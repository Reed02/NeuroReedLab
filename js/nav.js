...
(function () {
  ...
  const navHTML = `
    <nav class="navbar" id="site-navbar">
      <a href="index.html" class="logo">Neuro<em>Reed</em>Lab</a>
      <ul class="nav-links">
        <li><a href="index.html" ${isActive('index.html')}>Home</a></li>
        <li><a href="about.html" ${isActive('about.html')}>About</a></li>
        <li class="dropdown">
          <a href="projects.html" ${isActive('projects.html')}>Projects ▾</a>
        ...
        <li><a href="leave_testimonial.html" ${isActive('leave_testimonial.html')}>Leave a Testimonial</a></li>
